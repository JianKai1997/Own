...
public class Updatefood extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (thetext.isEmpty()) {
             JOptionPane.showMessageDialog(null, "Please fill in Food ID","Error",JOptionPane.ERROR_MESSAGE);
        }
        else
        {
            if (save.findCurMenu(thetext)!=0) {
                this.setVisible(false);
                save.setMenuForUpdate(thetext);
                Updatefood2 n = new Updatefood2(save);
            }
            else
            {

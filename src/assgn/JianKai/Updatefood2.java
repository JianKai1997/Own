...
public class Updatefood2 extends javax.swing.JFrame {
    ...
    public Updatefood2(store save) {
        ...
        initComponents();
        this.setTitle("Update Menu");
        foodid.setText(save.getCurMenuFOrUpdate().get(1).getFoodid());
        foodid.setEditable(false);
        foodname.setText(save.getCurMenuFOrUpdate().get(1).getFoodname());
        resname.setText(save.getCurAff().getResname());
        resname.setEditable(false);
        fooddesc.setText(save.getCurMenuFOrUpdate().get(1).getDesc());
        price.setText(save.getCurMenuFOrUpdate().get(1).getPrice());
        jComboBox1.setSelectedItem(save.getCurMenuFOrUpdate().get(1).getStatus());
    }
    ...
    private void cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelActionPerformed
        save.getCurMenuFOrUpdate().remove(1);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
       ...
       if (p.checkfn()  && p.checkdesc() && p.checkprice()) 
        {
            save.UpdateMenu(foodid.getText());
            int x = save.findCurMenu(foodid.getText());
            int y = save.findMenu(foodid.getText());
            save.getCurMenu().add(x,mc);
            save.getMenu().add(y,mc);
            save.getCurMenuFOrUpdate().remove(1);
